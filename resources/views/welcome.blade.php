    ...
    <body class="antialiased">
        <main class="min-h-screen flex items-center justify-center">
            <section class="max-w-2xl text-center space-y-4">
                ...
                <p class="text-on-surface-variant">Halaman ini tidak digunakan. Silakan gunakan halaman login.</p>
                <a href="{{ route('login') }}" class="text-primary font-bold hover:underline">Ke Halaman Login</a>
            </section>
        </main>
    </body>
</html><!DOCTYPE html>
        ...
        <main class="min-h-screen flex items-center justify-center">
            <section class="max-w-2xl text-center space-y-4">
                ...
                <p class="text-on-surface-variant">
                    Halaman ini sudah kembali ke Blade native. Silakan kembangkan tampilan di
