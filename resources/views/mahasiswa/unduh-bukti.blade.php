                                    ...
                                    <div class="flex-1 p-10">
                                        <div class="mb-10 flex gap-10">
                                            ...
                                            <div class="flex-1 space-y-6">
                                                ...
                                                <div class="border-b border-slate-100 pb-2">
                                                    ...
                                                    <p class="text-base font-bold text-primary">{{ $student->program_studi }}</p>
                                                </div>
                                                <div class="grid grid-cols-2 gap-4">
                                                    <div class="border-b border-slate-100 pb-2">
                                                        <p class="text-[10px] font-bold tracking-wide text-slate-400 uppercase">Asal Sekolah</p>
                                                        <p class="text-base font-bold text-primary">{{ $student->asal_sekolah }}</p>
                                                    </div>
                                                    <div class="border-b border-slate-100 pb-2">
                                                        <p class="text-[10px] font-bold tracking-wide text-slate-400 uppercase">Lokasi Ujian</p>
                                                        <p class="text-base font-bold text-primary">{{ $student->lokasi_ujian }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mt-auto flex items-end justify-between">
                                            ...
                                            <div class="text-center">
                                                <p class="mb-12 text-[10px] text-slate-500">Jakarta, 15 Juli 2024</p>
                                                <div class="mx-auto mb-2 h-16 w-32 border-b border-slate-300 relative">
                                                    <span class="absolute inset-0 flex items-center justify-center font-serif text-2xl italic text-primary/10 -rotate-6">Panitia PMB</span>
                                                </div>
                                                <p class="text-[10px] font-bold text-primary uppercase">Panitia Admisi Akademi PMB</p>
                                            </div>
                                        </div>
                                    </div>
